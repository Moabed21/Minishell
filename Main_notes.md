...
Used to inter-process communication ex. write two programs or in the same program use fork , you can make the simulation of process kill by sending a kill message to other process

there is a list of predefine signals ,
two of them , SIGUSR1 , SIGUSR2 are used freely by the user to define the type of signal wanted to be sent
